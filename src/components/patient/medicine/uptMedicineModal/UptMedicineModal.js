    ...
    <Modal>
      ...
      <div className="p-6 space-y-6">
        <form
          ...
          onSubmit={(e) => handleUptSubmit(e, uptData)}
        >
          <div className="grid gap-4 mb-4 grid-cols-2">
            <div className="col-span-2">
              ...
              <input
                ...
                value={uptData.patientmedicineName}
...
export default UptMedicineModal;
